class Blobs(object):
    ...
    def _get(self, module='mam', path=None, version=None, params=None, header=None):
    ...
    def _post(self, module='mam', path=None, version=None, params=None, data=None, json=None, header=None):
